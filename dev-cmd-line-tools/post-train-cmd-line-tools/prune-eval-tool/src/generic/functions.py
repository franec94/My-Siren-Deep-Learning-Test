...
from src.generic.custom_argparser import UNSTR_PRUNE_TECHS
...
def check_unstructured_prune_tech(opt):
    """Check whether unstructured tech provided by user from cmd line option is allowed."""
