...
def get_cmd_line_opts():
    ...
    parser.add_argument('--global_abs_linspace', type=int, required=False, default=0, dest='global_abs_linspace',
               help='Number of trials generated by means of np.linspace like function (default: 0, which means no linspace strategy to adopt)'
    )
